                ...
                <>
                  ...
                  <div className="mt-5 flex flex-wrap items-center gap-4">
                    ...
                    <div>
                      ...
                      <div className="flex h-10 items-center rounded border border-gray-200 text-black">
              ...
              {isAdmin && (
                <div className="mt-6 rounded-lg border border-gray-200 bg-gray-50 p-4">
                  ...
                  <p className="mt-1 text-[10px] text-gray-500">
                    Admin can view product details but
                    cannot purchase or add products to cart.
                  </p>
