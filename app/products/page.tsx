                ...
                <div className="space-y-2">
                  ...
                  {products.map(
                    (product) => (
                      ...
                      <div
                        key={product._id}
                        className="flex items-center gap-3 rounded-lg border border-gray-100 bg-white p-3 transition-shadow hover:shadow-sm"
                      >
                        ...
                        <div className="min-w-0 flex-1">
                          ...
                          <h3 className="mt-0.5 truncate text-[12px] font-bold text-gray-900">
                            {product.title}
                          </h3>
                        ...
                        <Link
                          ...
                          className="shrink-0 rounded bg-green-600 px-3 py-2 text-[9px] font-bold text-white transition-colors hover:bg-green-700"
                        >
                          VIEW MORE
                        </Link>
